...
class HistoricoStatus(Base):
    ...
    status_anterior = Column(SQLEnum(StatusOcorrencia, name="status_ocorrencia"))
    status_novo = Column(SQLEnum(StatusOcorrencia, name="status_ocorrencia"), nullable=False)
